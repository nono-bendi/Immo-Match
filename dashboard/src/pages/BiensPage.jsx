                  ...
                  >
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        {firstPhoto ? (
                          <div
                            className="w-12 h-12 rounded-xl bg-gray-100 overflow-hidden cursor-pointer hover:ring-2 hover:ring-[#1E3A5F]/30 transition-all hover:scale-105 relative"
                            onClick={() => openModal(bien)}
                          >
                            <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 rounded-xl" />
                            <img
                              src={firstPhoto}
                              alt={bien.type}
                              loading="lazy"
