...
export default function AdministrationPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 flex justify-end items-center gap-4 px-8 py-3 bg-white/90 backdrop-blur border-t border-gray-200 shadow-lg">
