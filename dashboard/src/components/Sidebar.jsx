import { Home, Users, UserPlus, Shuffle, Building2, History, Settings, ChevronRight, X, ShieldCheck, Target, Sparkles } from 'lucide-react'
...
function Sidebar({ isOpen, onClose }) {
  ...
  const menuItems = [
    ...
    { icon: Sparkles,         label: 'Bilan',        path: '/bilan' },
      ...
      <div className="flex items-center gap-3 px-2 mb-10">
        <div className="flex-1 min-w-0">
          <h1 className="font-extrabold text-xl leading-none" style={{ letterSpacing: '-0.04em' }}>
            <span className="text-white">Immo</span><span style={{ color: '#60a5fa', textShadow: '0 0 8px rgba(96,165,250,0.5), 0 0 18px rgba(96,165,250,0.25)' }}>Flash</span>
          </h1>
